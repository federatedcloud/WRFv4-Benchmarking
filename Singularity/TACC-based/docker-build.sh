...
#docker build --network=host --tag cornellcac/wrf:4.2.2-TACC ./ 2>&1 > $BUILD_OUTPUT_FILE

# Uncomment below to save build output log AND print to screen
docker build --network=host --tag cornellcac/wrf:4.2.2-TACC ./ 2>&1 | tee $BUILD_OUTPUT_FILE
